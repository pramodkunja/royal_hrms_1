...
class LeaveTypeModel extends LeaveTypeEntity {
  ...
  factory LeaveTypeModel.fromJson(Map<String, dynamic> json) {
    ...
    return LeaveTypeModel(
      ...
      code:              code,
      maxDays:           (json['annual_days'] as num? ?? 0).toInt(),
      isPaid:            code != 'LWP',
      carryForward:      json['can_carry_forward'] as bool? ?? false,
      docRequired:       code == 'SL' || code == 'ML' || code == 'PL',
...
class LeaveRequestModel extends LeaveRequestEntity {
  ...
  // status, reason, created_at, l1_remarks (rejection reason)
  factory LeaveRequestModel.fromJson(Map<String, dynamic> json) {
    ...
    return LeaveRequestModel(
      ...
      days:         (json['total_days'] as num? ?? 0).toInt(),
